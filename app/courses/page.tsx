...
export default function CoursesPage() {
  ...
  const coursesData = [
    ...
    // College Programs
    {
      id: 5,
      category: 'college',
      title: 'B.Com Complete Program (Economics, Costing & Taxation, Financial  Management)',
    ...
    },
    {
      id: 6,
      category: 'college',
      title: 'BBA Specialized Coaching (Accounts, Economics, Costing, Financial Management)',
      description: 'Complete BBA curriculum coverage with focus on management principles and business applications including Accounts, Economics, Costing, and Financial Management.',
      duration: '3 Years',
      level: 'Undergraduate',
    ...
    },
    {
      id: 7,
      category: 'college',
      title: 'MBA Executive Program (Accounts, Economics, Costing, Financial Management)',
      description: 'Advanced MBA coaching with specialization in Finance, Marketing, and Human Resource Management including Accounts, Economics, Costing, and Financial Management.',
      duration: '2 Years',
      level: 'Postgraduate',
    ...
    },
    {
      id: 13,
      category: 'professional',
      title: 'CS Foundation Program (Accounts ,Economics, Costing)',
    ...
    },
    {
      id: 14,
      category: 'professional',
      title: 'CS Executive Program (Accounts ,Economics, Costing)',
