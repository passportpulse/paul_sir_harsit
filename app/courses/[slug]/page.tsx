...
const coursesDatabase = {
  ...
  'bcom-complete-program': {
    ...
    description: 'All-semester B.Com coaching covering Financial Accounting, Economics, Costing, Taxation, and Financial Management.',
    longDescription: 'Our B.Com Complete Program offers comprehensive coaching for all six semesters of B.Com with specialized focus on Economics, Costing & Taxation, and Financial Management. With expert faculty and structured curriculum, we ensure students gain deep understanding of accounting principles, economic theories, taxation laws, and financial management concepts.',
    duration: '3 Years',
    level: 'Undergraduate',
